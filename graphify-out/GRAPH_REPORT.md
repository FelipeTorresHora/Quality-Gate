...
### Community 0 - "test_analysis_execution.py"
Cohesion: 0.05
...
### Community 2 - "github_installation_service.py"
Cohesion: 0.15
...
### Community 7 - "routes_repositories.py"
Cohesion: 0.12
...
### Community 8 - "AnalysisDetailPage.tsx"
Cohesion: 0.09
...
### Community 9 - "test_ai_review_graph.py"
Cohesion: 0.12
...
### Community 11 - "test_coverage_execution_config.py"
Cohesion: 0.10
...
### Community 16 - "RepositoryPullRequestsPage.tsx"
Cohesion: 0.16
...
### Community 17 - "AnalysisRunStatus"
Cohesion: 0.24
...
### Community 21 - "test_github_webhooks.py"
Cohesion: 0.16
...
### Community 24 - "github_oauth_service.py"
Cohesion: 0.17
...
### Community 26 - "DashboardPage.tsx"
Cohesion: 0.15
...
### Community 27 - "dashboard_service.py"
Cohesion: 0.23
...
### Community 28 - "test_github_client_context.py"
Cohesion: 0.14
...
### Community 29 - "test_repositories.py"
Cohesion: 0.18
...
### Community 30 - "PR Quality Gate Dashboard"
Cohesion: 0.10
...
### Community 31 - "test_runner_protocol.py"
Cohesion: 0.16
...
### Community 33 - "github_publication_service.py"
Cohesion: 0.31
...
### Community 34 - "test_github_publication.py"
Cohesion: 0.23
...
### Community 39 - "test_runner_secrets.py"
Cohesion: 0.18
...
### Community 40 - "tests/conftest.py"
Cohesion: 0.21
...
### Community 44 - "analysis_execution_service.py"
Cohesion: 0.42
...
### Community 45 - "test_ai_review_evals.py"
Cohesion: 0.23
...
### Community 46 - "analysis_evidence_workspace.py"
Cohesion: 0.25
...
### Community 59 - "graphify reference: commit hook and native AGENTS.md integration"
Cohesion: 0.50
...
### Community 74 - "_process_installation_event"
Cohesion: 1.00
...
- **Why does `Architecture` connect `AnalysisDetailPage.tsx` to `GitHubClient`, `github_installation_service.py`, `get_settings`, `AnalysisRun`, `test_auth.py`, `test_ai_review_graph.py`, `client.ts`, `RepositoryPullRequestsPage.tsx`, `AnalysisRunStatus`, `CLAUDE.md`, `DashboardPage.tsx`?**
  _High betweenness centrality (0.175) - this node is a cross-community bridge._
- **Why does `get_settings()` connect `get_settings` to `github_publication_service.py`, `github_installation_service.py`, `GitHubClient`, `test_auth.py`, `quality_gate_service.py`, `runner_service.py`, `routes_repositories.py`, `test_runner_secrets.py`, `test_ai_review_graph.py`, `AnalysisDetailPage.tsx`, `RunnerError`, `analysis_execution_service.py`, `test_analysis_queue.py`, `graph.py`, `test_github_webhooks.py`, `github_oauth_service.py`, `env.py`, `test_runner_protocol.py`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `AnalysisRunStatus` connect `AnalysisRunStatus` to `test_analysis_execution.py`, `GitHubClient`, `github_publication_service.py`, `AnalysisRun`, `test_github_publication.py`, `routes_repositories.py`, `AnalysisDetailPage.tsx`, `test_ai_review_graph.py`, `analysis_execution_service.py`, `FindingCategory`, `test_analysis_queue.py`, `test_github_webhooks.py`, `dashboard_service.py`, `test_repositories.py`?**
